        ...
        return {
            resume: {
                base: {
                    ...
                    mail: "siying.chen@yahoo.com | 12月2号回国",
                ...
                works: [{
                    ...
                    【项目内容】1. 搜索，收集，整理，清洗，更新，分析公司负责地区的洪灾，火灾，大型鸟类相关数据以及电网设备数据，并撰写报告
                ...
                projects: [
                    ...
                    },
                    {
                       name: "尼姆市公共交通TANGO线路更新规划方案",
                        ...
                        【项目内容】1.制作城市规划分析表，并分析相关数据以建立并确认“优先指数 (indice de priorité）”以划分优先享受公交服务的街区范围，再制作相关主题地图
                        2.根据相关指数分析尼姆市旧公交线路的合理与不合理处，并优化并制作每条新公交线路的分布
                        3.整合并制作新公共交通线路地图，分析制作新旧线路经济报告表
                        【项目成果】1.降低了公交服务人口覆盖率，由88.94 %降低为82.26 %，减少富人区（多车家庭）公交服务覆盖率。
                        2.提高优先服务区域的覆盖率。
                        3.删除五条公交汽车线路以降低不必要的支出，将原五条线路的必要站点划分到其他公交线路范围。
                        4.与原支出相比共节约大约130万欧元。
                ...
                educations: [
                    {
                        ...
                        content: `主要相关课程：计算机课程(JAVA, Python, linux), 数据分析(MySQL, R), 数学, 统计学, 地理交通, 遥感, WebGis(HTML,PHP,JavaScritp,GeoServer,Leaflet), 地图学(ArcgisPro, Qgis, Illustrator), 地理空间数据分析(Postgres, postgis, PGAdmin, ArcgisPro)，土地空间规划，交通规划
                         `
